                            ...
                            <form action="/update-profile" method="POST">
                                ...
                                <div class="mt-30">
                                    ...
                                    <div class="icon-input-group">
                                        <input class="form-control" type="text" id="inp_title" name="name" value="{{$user->name}}" required/>
                                ...
                                <div class="mt-30">
                                    ...
                                    <div class="icon-input-group">
                                        <input class="form-control" type="text" id="inp_title" name="email" value="{{$user->email}}"/>
                                        <i class="icon_chat_alt"></i>
                                    </div>
                                </div>
                                <div class="mt-30">
                                    ...
                                    <div class="icon-input-group">
                                        <input class="form-control" type="password" id="inp_title2" name="password" value=""/>
                                        <i class="icon_chat_alt"></i>
                                    </div>
                                </div>
                                @if($user->user_meta != null)
                                    <div class="mt-30">
                                        ...
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="proffession" value="{{$user->user_meta->proffession}}" required/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                ...
                                @else
                                    <div class="mt-30">
                                        <label class="label" for="inp_title">Profession/Department <span>*</span></label>
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="proffession" value="{{$user->userMeta->proffession}}"/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-30">
                                        <label class="label" for="inp_title">Phone <span>*</span></label>
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="phone" value="{{$user->userMeta->phone}}"/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-30">
                                        <label class="label" for="inp_title">Location <span>*</span></label>
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="location" value="{{$user->userMeta->location}}"/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                    <div class="mt-30">
                                        <label class="label" for="inp_title">Age <span>*</span></label>
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="age" value="{{$user->userMeta->age}}"/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                    <div class="mt-30">
                                        <label class="label" for="inp_title">Experience <span>*</span></label>
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="experience" value="{{$user->userMeta->experience}}"/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                    <div class="mt-30">
                                        <label class="label" for="inp_title">Portfolio Site<span>*</span></label>
                                        <div class="icon-input-group">
                                            <input class="form-control" type="text" id="inp_title2" name="portfolio_site" value="{{$user->userMeta->portfolio_site}}"/>
                                            <i class="icon_chat_alt"></i>
                                        </div>
                                    </div>
                                    <div class="mt-25">
